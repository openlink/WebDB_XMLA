...
function $nsDatabase(options, conn_ver, ver_exists, readonly) {
  ...
  if (typeof($OPLUtils)=="undefined" || $OPLUtils==null)
    $OPLUtils = new ActiveXObject("openlinksw.WebDB_to_XMLA.1");
}
...
function $nsSQLException(ex) {
  if (ex.code && typeof(ex.code)!="undefined") 
    this.code = ex.code;
  else
    this.code = -1;
...
var _soap = "http://www.w3.org/2003/05/",
    _xmlnsSOAPenvelope = _soap + "soap-envelope",
    _xmlnsSOAPenvelope1 = "http://schemas.xmlsoap.org/soap/envelope/",
    _xmlnsSOAPenvelopePrefix = "SOAP-ENV",
    _xmlnsIsSOAPenvelope = "xmlns:" + _xmlnsSOAPenvelopePrefix + "=\"" + _xmlnsSOAPenvelope + "\"",
    _SOAPencodingStyle = _xmlnsSOAPenvelopePrefix + ":encodingStyle=\"" + _soap + "soap-encoding\"",
...
*/
    ...
    xhr.setRequestHeader("X-PINGRUN", "ping");
