...
{
#ifdef CHROME
  return (char*)"application/xmla-chrome:.:NPXMLA_Chrome;application/xmla:.:NPXMLA_Chrome";
#else
  return (char*)"application/xmla:.:NPXMLA;application/xmla-safari:.:NPXMLA;application/xmla-opera:.:NPXMLA";
#endif
}
...
#ifdef CHROME
    *((char **)value) = (char*)"NPXMLA_Chrome";
#else
    *((char **)value) = (char*)"NPXMLA";
#endif
    break;
  case NPPVpluginDescriptionString:
#ifdef CHROME
    *((char **)value) = (char*)"OpenLink HTML5 WebDb-to-XMLA (Bridge) Plugin ver:1.0.8 for Chrome";
#else
    *((char **)value) = (char*)"OpenLink HTML5 WebDb-to-XMLA (Bridge) Plugin ver:1.0.8";
#endif
    break;
