...
const CLASS_ID = Components.ID("a0a3af3f-910c-47d7-8f8a-4ff18a7c5b06");
const CLASS_NAME = "XMLAUtils";
const CONTRACT_ID = "@openlinksw.com/WebXMLADatabase;1";
...
XMLAWebSQL.prototype = {
  // for nsISupports
  QueryInterface: function(aIID)
  {
    if (!aIID.equals(Ci.nsIWorkerXMLADatabase) &&
  ...
  getInterfaces : function(count) {
    var interfaceList = [Ci.nsIWorkerXMLADatabase, Ci.nsISecurityCheckedComponent, Ci.nsIClassInfo];
  ...
  openXMLADatabaseSync : function (url, dsn, cat, uid, pwd, version, creationCallback) {
    var db = (this.openXMLA(url, dsn, cat, uid, pwd, version, true)).QueryInterface(Ci.nsIXMLADatabaseSync);
    if (creationCallback) {
  ...
  openXMLADatabase : function (url, dsn, cat, uid, pwd, version, creationCallback) {
    var db = (this.openXMLA(url, dsn, cat, uid, pwd, version, false)).QueryInterface(Ci.nsIXMLADatabase);
    if (creationCallback) {
      creationCallback.handleEvent(db);
    }
    return db;
  ...
  discoverDataSources : function (_url) {
    ...
    try {
      ...
      return (new $nsSQLResultSet(_rs)).QueryInterface(Ci.nsIXMLAResultSet);
...
var XMLAWebSQLFactory = {
  ...
  createInstance: function (aOuter, aIID)
  {
    ...
    if (this.singleton === null)
      this.singleton = new XMLAWebSQL();
    return this.singleton.QueryInterface(aIID);
  }
};

// Module
var XMLAWebSQLModule = {
...
function NSGetModule(aCompMgr, aFileSpec) { return XMLAWebSQLModule; };
...
$nsDatabaseSync.prototype = {
  ...
  QueryInterface: function(aIID)
  {
    if (!aIID.equals(Ci.nsIXMLADatabaseSync) &&
        !aIID.equals(Ci.nsISecurityCheckedComponent) &&
        !aIID.equals(Ci.nsISupports))
        throw Cr.NS_ERROR_NO_INTERFACE;
    return this;
...
$nsDatabase.prototype = {
  ...
  QueryInterface: function(aIID)
  {
    if (!aIID.equals(Ci.nsIXMLADatabase) &&
        !aIID.equals(Ci.nsISecurityCheckedComponent) &&
        !aIID.equals(Ci.nsISupports))
        throw Cr.NS_ERROR_NO_INTERFACE;
    return this;
...
$nsSQLException.prototype = {
  ...
  QueryInterface: function(aIID)
  {
    if (!aIID.equals(Ci.nsIXMLAException) &&
        !aIID.equals(Ci.nsISecurityCheckedComponent) &&
        !aIID.equals(Ci.nsISupports))
        throw Cr.NS_ERROR_NO_INTERFACE;
    return this;
...
$nsSQLError.prototype = {
  ...
  QueryInterface: function(aIID)
  {
    if (!aIID.equals(Ci.nsIXMLAError) &&
        !aIID.equals(Ci.nsISecurityCheckedComponent) &&
        !aIID.equals(Ci.nsISupports))
        throw Cr.NS_ERROR_NO_INTERFACE;
    return this;
...
$nsSQLTransactionSync.prototype = {
  ...
  QueryInterface: function(aIID)
  {
    if (!aIID.equals(Ci.nsIXMLATransactionSync) &&
        !aIID.equals(Ci.nsISecurityCheckedComponent) &&
        !aIID.equals(Ci.nsISupports))
        throw Cr.NS_ERROR_NO_INTERFACE;
    return this;
  ...
  getProcedures : function (catalog, schema, procedure) {
    return (new $nsSQLResultSetEmpty()).QueryInterface(Ci.nsIXMLAResultSet);
  },
...
$nsSQLTransaction.prototype = {
  ...
  QueryInterface: function(aIID)
  {
    if (!aIID.equals(Ci.nsIXMLATransaction) &&
        !aIID.equals(Ci.nsISecurityCheckedComponent) &&
        !aIID.equals(Ci.nsISupports))
        throw Cr.NS_ERROR_NO_INTERFACE;
    return this;
...
$nsSQLResultSet.prototype = {
  ...
  QueryInterface: function(aIID)
  {
    if (!aIID.equals(Ci.nsIXMLAResultSet) &&
        !aIID.equals(Ci.nsISecurityCheckedComponent) &&
        !aIID.equals(Ci.nsISupports))
        throw Cr.NS_ERROR_NO_INTERFACE;
    return this;
  ...
  get rowsAffected()   { 
    if (this._rs!=null && this._rs.fieldCount() > 0)
      return -1; 
    else
      return 0;
  }, 
  ...
  get rows()           {
    if (!this._rows)
      this._rows = (new $nsSQLResultSetRowList(this._rs)).QueryInterface(Ci.nsIXMLAResultSetRowList);
    return this._rows;
  },

  get metaData()       {
    if (!this._meta)
      this._meta = (new $nsSQLResultSetMetaData(this._rs)).QueryInterface(Ci.nsIXMLAResultSetMetaData);
    return this._meta;
  },
...
$nsSQLResultSetEmpty.prototype = {
  ...
  get rows()           {
    if (!this._rows)
      this._rows = (new $nsSQLResultSetRowListEmpty()).QueryInterface(Ci.nsIXMLAResultSetRowList);
    return this._rows;
  },

  get metaData()       {
    if (!this._meta)
      this._meta = (new $nsSQLResultSetMetaDataEmpty()).QueryInterface(Ci.nsIXMLAResultSetMetaData);
    return this._meta;
  },
...
$nsSQLResultSetRowList.prototype = {
  ...
  QueryInterface: function(aIID)
  {
    if (!aIID.equals(Ci.nsIXMLAResultSetRowList) &&
        !aIID.equals(Ci.nsISecurityCheckedComponent) &&
        !aIID.equals(Ci.nsISupports))
        throw Cr.NS_ERROR_NO_INTERFACE;
    return this;
...
$nsSQLResultSetMetaData.prototype = {
  ...
  QueryInterface: function(aIID)
  {
    if (!aIID.equals(Ci.nsIXMLAResultSetMetaData) &&
        !aIID.equals(Ci.nsISecurityCheckedComponent) &&
        !aIID.equals(Ci.nsISupports))
        throw Cr.NS_ERROR_NO_INTERFACE;
    return this;
...
var _soap = "http://www.w3.org/2003/05/";
var _xmlnsSOAPenvelope = _soap + "soap-envelope";
var _xmlnsSOAPenvelope1 = "http://schemas.xmlsoap.org/soap/envelope/";
var _xmlnsSOAPenvelopePrefix = "SOAP-ENV";
var _xmlnsIsSOAPenvelope = "xmlns:" + _xmlnsSOAPenvelopePrefix + "=\"" + _xmlnsSOAPenvelope + "\"";
var _SOAPencodingStyle = _xmlnsSOAPenvelopePrefix + ":encodingStyle=\"" + _soap + "soap-encoding\"";
var _ms = "urn:schemas-microsoft-com:";
var _xmlnsXmla = _ms + "xml-analysis";
var _xmlnsIsXmla = "xmlns=\"" + _xmlnsXmla + "\"";
var _xmlnsSQLPrefix = "sql";
var _xmlnsSQL = _ms + "xml-sql";
var _xmlnsSchema = "http://www.w3.org/2001/XMLSchema";
var _xmlnsSchemaPrefix = "xsd";
var _xmlnsSchemaInstance = "http://www.w3.org/2001/XMLSchema-instance";
var _xmlnsSchemaInstancePrefix = "xsi";
var _xmlnsRowset = _xmlnsXmla + ":rowset";
var _xmlnsEmpty = _xmlnsXmla + ":empty";
var _xmlnsResultset = _xmlnsXmla + ":mddataset";
var _useAX = false; //window.ActiveXObject ? true : false;
...
//??orig    xhr.setRequestHeader("Content-Type", "text/xml");
    if (options.method == Xmla.METHOD_DISCOVER)
      xhr.setRequestHeader("Content-Type", "application/soap+xml; action=\"urn:schemas-microsoft-com:xml-analysis:Discover\"");
    else if (options.method == Xmla.METHOD_EXECUTE)
      xhr.setRequestHeader("Content-Type", "application/soap+xml; action=\"urn:schemas-microsoft-com:xml-analysis:Execute\"");
    else
...
function _getXmlaSoapList(container, listType, items){
    var numItems, i, entry, property, item, msg = "<" + container + ">";
    if (items) {
        msg += " <" + listType + ">";
    ...
    switch(method){
        ...
        case Xmla.METHOD_EXECUTE:
            if (options.statement){
                msg += "" + 
                "<Command>" +
                "<Statement>" + _xmlEncodeListEntry(options.statement) + "</Statement>" + 
                "</Command>" + 
                _getXmlaSoapList("Properties", "PropertyList", options.properties)
                ;
            }
...
//??orig    if (overwrite || _isUnd(object[property])) {
...
Xmla.DBSCHEMA_PRIMARY_KEYS =    _xmlaDBSCHEMA + "PRIMARY_KEYS";

Xmla.DBSCHEMA_FOREIGN_KEYS =    _xmlaDBSCHEMA + "FOREIGN_KEYS";
...
*/        
    ...
    discoverDBPrimaryKeys: function(options){
        var request = _applyProps(
            options,
            {
                requestType: Xmla.DBSCHEMA_PRIMARY_KEYS
            },
            true
        );
        return this.discover(request);
    ...
    discoverDBForeignKeys: function(options){
        var request = _applyProps(
            options,
            {
                requestType: Xmla.DBSCHEMA_FOREIGN_KEYS
            },
            true
        );
        return this.discover(request);
...
Xmla.Rowset.prototype = {
    ...
    _initData: function(){
        ...
        if (rowSchema){    
//??orig            var seq = _getElementsByTagNameNS(rowSchema, _xmlnsSchema, _xmlnsSchemaPrefix, "sequence").item(0),
            var seq = _getElementsByTagNameNS(rowSchema, _xmlnsSchema, _xmlnsSchemaPrefix, "choice").item(0),
...
//??added
		if (type===null)
          ...
          var testEmpty = _getElementsByTagNameNS(this._node, _xmlnsEmpty, null, "root");
    ...
    _getValueConverter: function(type){
        ...
        switch (type){
            case "boolean":
                ...
                break;
            case "decimal": //FIXME: not sure if you can use parseFloat for this.
            case "double":
            case "float":
...
Xmla.Exception._newError = function(codeName, source, data, srvResponse){
    var xmlDoc = null;
    if (srvResponse != null) {
       xmlDoc = _createXmlDoc(srvResponse);
       var soapFault = _getElementsByTagNameNS(xmlDoc, _xmlnsSOAPenvelope, _xmlnsSOAPenvelopePrefix, "Fault");
       if (soapFault.length) {
         var _faultcode = soapFault.item(0).getElementsByTagName("faultcode");
         if (_faultcode.length > 0) {
           return new Xmla.Exception(
                Xmla.Exception.TYPE_ERROR,
                soapFault.item(0).getElementsByTagName("faultcode").item(0).childNodes.item(0).data,
                soapFault.item(0).getElementsByTagName("faultstring").item(0).childNodes.item(0).data,
                null,
                "_requestError",
                data
            );
           ...
           var fDetail = _getElementsByTagNameNS(xmlDoc, _xmlnsSOAPenvelope, _xmlnsSOAPenvelopePrefix, "Detail");
           if (fDetail.length > 0) {
             try {
               var _err = soapFault.item(0).getElementsByTagName("Error").item(0);
               return new Xmla.Exception(
                  Xmla.Exception.TYPE_ERROR,
                  _err.getAttribute("ErrorCode"),
                  _err.getAttribute("Description"),
                  null,
                  "_requestError",
                  data
                );
             ...
             var fText = _getElementsByTagNameNS(xmlDoc, _xmlnsSOAPenvelope, _xmlnsSOAPenvelopePrefix, "Text");
             if (fText.length > 0) {
               return new Xmla.Exception(
                  Xmla.Exception.TYPE_ERROR,
                  "-1",
                  fText.item(0).childNodes.item(0).data,
                  null,
                  "_requestError",
                  data
               );
